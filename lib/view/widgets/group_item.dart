...
class GroupItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: (){
        Navigator.of(context).push(MaterialPageRoute(builder: (ctx)=> ProductsOfGroupPage(groupId: groupModel.id.toString())));
      },
      child: Stack(
                    ...
                    child: Stack(
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                              borderRadius: BorderRadius.circular(15),
                              child: ((groupModel.banners?.length ??
                                  0) ==
                                  0)
                                  ? const cupertino.SizedBox.shrink()
                                  : Image.network(
          ...
          PositionedDirectional(
            ...
            child: SizedBox(
              ...
              child: cupertino.ListView.separated(
                ...
                itemCount:
                groupModel.mainCategoriesForProductIds!.length,
              ),
            ),
          ),
        ],
